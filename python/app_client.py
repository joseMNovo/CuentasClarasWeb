...
# Si se quiere probar desde consola:
if __name__ == "__main__":
    # Ejemplo de uso:
    print("Ejemplo de cálculo:")
    print(calcular_cuentas("1000", "2000", "900"))
    print("Agregando al historial...")
    print(agregar_a_historial("1000", "2000", "900"))
    print("Historial actual:")
    print(obtener_historial())
    print("Eliminando registro con id=1")
    print(eliminar_registro_historial(1))
    print("Historial después de eliminar:")
    print(obtener_historial())
